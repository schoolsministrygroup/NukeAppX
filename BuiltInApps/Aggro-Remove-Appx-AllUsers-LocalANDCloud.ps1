...
Added lines to beginning of script: approximating  Get-appxprovisionedpackage –online | where-object {$_.packagename –like "*Office.OneNote*"} | remove-appxprovisionedpackage –Online -AllUsers 
